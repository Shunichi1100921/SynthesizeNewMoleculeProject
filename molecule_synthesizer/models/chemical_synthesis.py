...
class RemoveHydrogen(object):
    ...
    def find_atom_idx_by_attype(self) -> Dict[str, int]:
        ...
        for atom_idx in self.fragment.bond[self.bond_idx_to_remove]:
            if self.fragment.attypes[atom_idx] == 'hydrogen':
                attype_in_bond['hydrogen'] = atom_idx
            else:
                attype_in_bond[self.bind_fragment] = self.fragment.bind_fragment[atom_idx]
    ...
    def remove_bond(self) -> None:
        ...
        # Add free atom.
        self.fragment.free_atom += self.atom_idx_by_attype[self.bind_fragment]
        ...
        del self.fragment.long_bond_idx[self.bond_idx_to_remove]
